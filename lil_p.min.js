...
return this;}};}());(function(){String.method("pluralize",function(value){value=value||0;
...
if(typeof suffix==="undefined"){suffix=" ago";}else{suffix=" "+suffix.trim();}if(from instanceof Date===false){from=new Date();
