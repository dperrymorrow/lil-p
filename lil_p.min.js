(function(){String.method("pluralize",function(value){value=value||2;return parseInt(value,10)>1?this+"s":this;
});String.method("contains",function(checkFor){return this.indexOf(checkFor.toString())!==-1;
...
Date.timeUnitsOrder=["year","month","week","day","hour","minute","second"];Date.method("setTimeAgo",function(phrase){var amount,unit,arr=phrase.split(" ");
if(arr.length!==2){throw"You must pass in a phrase in '2 Years' format!";}amount=parseInt(arr[0],10);
unit=arr[1].toLowerCase().singularize();this.setTime(this.getTime()-(amount*Date.timeStampUnits[unit]));
