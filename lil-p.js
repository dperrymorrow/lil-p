/*global window:true, JQuery:true, RPM:true, window:true, docuemnt:true */
/*jslint eqeq: false, plusplus: false, sloppy: true, indent: 2*/
...
String.method('pluralize', function (value) {
  ...
  if (value > 1 || value === 0) { return this + "s"; }
  return this;
});
...
String.method('truncate', function (length, append) {
  append = append || '...';
  length = length || 10;
  var shortened = this.substring(0, length);
...
// DATE PROTOTYPE EXTENSION FUNCTIONS...
